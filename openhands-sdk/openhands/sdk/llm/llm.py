...
from openhands.sdk.secret import EnvSecret, SecretSource, StaticSecret
from openhands.sdk.utils.models import OpenHandsModel


logger = get_logger(__name__)

__all__ = ["LLM", "LLMProfile"]
...
class LLMProfile(OpenHandsModel):
    ...
    def hydrate(self) -> LLM:
        ...
        # We use model_dump + update + LLM() to ensure validators (like SecretStr promotion) run
